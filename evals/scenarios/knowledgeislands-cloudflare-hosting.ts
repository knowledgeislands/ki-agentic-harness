/**
 * Eval scenarios for the `knowledgeislands-cloudflare-hosting` skill — the deploy/serve
...
export const scenarios: Scenario[] = [
  {
    skill: 'knowledgeislands-cloudflare-hosting',
    id: 'host-not-pages',
    prompt:
