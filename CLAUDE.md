...
- **Hooks** — the plan-file lifecycle pair registers via `.claude/settings.json` (`ki:hooks:link:global`); these ride Claude Code's native Plan Mode and have no confirmed Codex equivalent.
