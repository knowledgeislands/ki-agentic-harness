...
2. Verify open delivery tasks belong to the project for their actual repository. Use Coordination only for company operations and cross-repository planning, not repository implementation. Archived umbrella projects are historical, not destinations for new delivery. Formal trade routes must stay within the company boundary: do not create bridges to HNR, legal, personal or other company groups. KI-internal maintenance, Techne and public-source intake grants are configured in the participating repositories; inspect those declarations rather than recreating them. Their standing knowledge grants do not authorize execution or publication.
