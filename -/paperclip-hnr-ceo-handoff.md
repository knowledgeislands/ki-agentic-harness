...
4. Keep upstream KI concerns, including HUM-20, on the receiving repository's coordination/trade route. HNR task ownership does not authorize edits to KI repositories. Likewise, cross-repository planning tasks do not authorize delivery in every repository they mention.
