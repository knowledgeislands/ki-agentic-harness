...
| FRAMEWORK | `arcadia-skills/README.md` "governance-skill shape" + "Principles across the set" | the enforcement framework (modes, checker contract, rubric tagging, sources cadence) | 2026-06-14    |

† the 7 `mcp-*` servers + `arcadia-skills`, `arcadia-principal`, `arcadia-website`.
