...
Hooks have no dedicated governing skill yet — they are advisory, like [evals/](../evals). The five-part bundle layout is fixed by ADR-KI-HARNESS-004 and governed by the **`ki-harness`** skill under [skills/](../skills).
