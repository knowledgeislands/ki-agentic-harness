...
- `skills/general-governance/ki-skills/references/rubric.md` — the line-by-line criteria with `[M]`/`[J]` tags
- `skills/general-governance/ki-skills/references/standards.md` — the normative standard behind the rubric
