...
Every skill in the harness, grouped by cluster in the order of [the six clusters](skills.md#the-six-clusters). Each entry says what the skill governs and names its mechanical checker.
