...
| [foundation-tooling/003](foundation-tooling/plans/003-rollout-documentation-baseline.md) | foundation-tooling | Reconcile rollout documentation | foundation-tooling/reconcile-the-fleet-s-toolchain-prose-with-the-collapsed-toolchain | open | foundation-tooling/004 |
