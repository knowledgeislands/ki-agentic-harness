...
| --- | --- | --- | --- | --- | --- |
| [foundation-tooling/001](foundation-tooling/plans/001-universal-audit-applicability.md) | foundation-tooling | Make audit applicability universal | foundation-tooling/make-ki-audit-a-fully-universal-clean-gate-na-skip-the-remaining-over-reaching-audits | open | foundation-tooling/003, foundation-tooling/004 |
