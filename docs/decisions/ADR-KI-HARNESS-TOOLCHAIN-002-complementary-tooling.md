...
- [ADR-KI-HARNESS-001](ADR-KI-HARNESS-001-composition-over-extension.md) — Composition over extension (the paradigm the declines protect).
- [ADR-KI-HARNESS-CONFIG-001](ADR-KI-HARNESS-CONFIG-001-validate-down-ki-config-contract.md) — Validate-down `.ki-config.toml` contract.
