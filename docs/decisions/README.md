...
47. [ADR-KI-HARNESS-SKILLS-014](ADR-KI-HARNESS-SKILLS-014-explicit-skill-applicability.md) — exhaustive repository applicability classification and detector ownership.
