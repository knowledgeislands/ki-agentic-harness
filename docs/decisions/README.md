...
30. [ADR-KI-HARNESS-SKILLS-011](ADR-KI-HARNESS-SKILLS-011-repo-roadmaps-for-non-kb-repositories.md) — the non-KB repo-roadmap profiles, thematic plan layout, and Knowledge Base Streams boundary.
