...
### Project roadmaps — the _when_

[`roadmap/`](roadmap) holds this non-KB repository's canonical thematic roadmaps and their near-horizon implementation plans. The root [`ROADMAP.md`](../ROADMAP.md) is the generated portfolio view; `ki-project-roadmap` governs both layers. Knowledge Bases use `ki-kb-streams` instead of this project-roadmap layout.
