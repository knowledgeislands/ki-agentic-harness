...
[`knowledgeislands-kb`](../skills/knowledgeislands-kb/SKILL.md); the **`Streams` zone** — its internal structure and the Enactment Process
that governs work in motion — is owned by [`knowledgeislands-streams`](../skills/knowledgeislands-streams/SKILL.md), which
`knowledgeislands-kb` delegates to.
