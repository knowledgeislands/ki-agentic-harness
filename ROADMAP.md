...
- [Foundation Tooling: Explicitly test the `.ki-meta/bin/ki-audit`/`ki-conform` shell wrapper against the `bun run ki:*` package.json path](docs/roadmap/foundation-tooling/ROADMAP.md#explicitly-test-the-ki-metabinki-auditki-conform-shell-wrapper-against-the-bun-run-ki-packagejson-path)
...
- [Foundation Tooling: Gate the hand-pasted skill-graph tree in `skills.md` against its generator _(candidate)_](docs/roadmap/foundation-tooling/ROADMAP.md#gate-the-hand-pasted-skill-graph-tree-in-skillsmd-against-its-generator-candidate)
...
- [Governance Consistency: Separate KI-opinionated conventions from genuinely general/portable standards _(candidate)_](docs/roadmap/governance-consistency/ROADMAP.md#separate-ki-opinionated-conventions-from-genuinely-generalportable-standards-candidate)
...
- [Operations: Extend `ki-housekeeping` to cover `~/.claude/workflows/` _(candidate)_](docs/roadmap/operations/ROADMAP.md#extend-ki-housekeeping-to-cover-claudeworkflows-candidate)
- [Operations: Make `ki-recap`'s "surface outstanding" leg explicitly state when there's nothing outstanding _(candidate)_](docs/roadmap/operations/ROADMAP.md#make-ki-recaps-surface-outstanding-leg-explicitly-state-when-theres-nothing-outstanding-candidate)
...
- [Runtime Portability: De-mandate chezmoi as `ki-binding`'s MCP-config source](docs/roadmap/runtime-portability/ROADMAP.md#de-mandate-chezmoi-as-ki-bindings-mcp-config-source)
...
- [Website Docs: Guard the website's vendored docs against drift from the harness's canonical copy _(candidate)_](docs/roadmap/website-docs/ROADMAP.md#guard-the-websites-vendored-docs-against-drift-from-the-harnesss-canonical-copy-candidate)
