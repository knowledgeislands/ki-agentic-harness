#!/usr/bin/env bun
/**
 * ki-engineering EDUCATE — the mechanical half (ADR-KI-HARNESS-SKILLS-001 / -007). A thin
 * delegator: it execs the ki-bootstrap chain engine with this skill as an explicit
 * `--seed`, so running this file bootstraps ki-engineering — plus everything it `implies:`
...
const SKILL = 'ki-engineering'
const HELP = `Usage: bun scripts/educate.ts <target-repo> [--ref <ref>] [--dry-run]

Educate a repository with ki-engineering and its declared dependencies.
`
