...
```jsonc
{
  "scripts": {
    ...
    "ki:engineering:audit": "bun .ki-meta/checkers/ki-engineering/audit.ts .",
    "ki:engineering:conform": "bun .ki-meta/checkers/ki-engineering/conform.ts .",
    "ki:authoring:audit": "bun .ki-meta/checkers/ki-authoring/audit.ts .",
    "ki:authoring:conform": "bun .ki-meta/checkers/ki-authoring/conform.ts .",
