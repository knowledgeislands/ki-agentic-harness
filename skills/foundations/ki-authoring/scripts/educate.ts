#!/usr/bin/env bun
/**
 * ki-authoring EDUCATE — the mechanical half (ADR-KI-HARNESS-SKILLS-001 / -007). A thin
 * delegator: it execs the ki-bootstrap chain engine with this skill as an explicit
 * `--seed`, so running this file bootstraps ki-authoring — plus everything it `implies:`
...
Bootstrap ki-authoring as an explicitly seeded governance skill in a target repository.
`)
  process.exit(0)
}
