...
- Read the repository's `docs/guides/developer/done.md` and `docs/guides/developer/releasing.md`, then follow their local requirements. This shared checklist complements those repository-specific procedures; it does not replace them.
