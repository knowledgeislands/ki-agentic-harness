...
7. **Make progress visible.** The orchestrator owns caller-facing communication; workers report their state to the orchestrator, rather than independently sending user-facing updates. Send a compact update at these points:
   ...
   - at least every five minutes while work remains open, when the caller has not set a cadence.
