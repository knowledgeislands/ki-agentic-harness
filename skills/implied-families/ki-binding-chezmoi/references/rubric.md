...
- **BINDCHEZ-7 [J]** — this rubric, [the standard](standards.md), and [the checker](../scripts/audit.ts)'s constants agree; when the standard moves, all three move together (Mode REFRESH).
