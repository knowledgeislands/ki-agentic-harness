#!/usr/bin/env bun
/**
 * ki-website-cloudflare EDUCATE — the mechanical half (ADR-KI-HARNESS-SKILLS-001 / -007). A thin
 * delegator: it execs the ki-bootstrap chain engine with this skill as an explicit
 * `--seed`, so running this file bootstraps ki-website-cloudflare — plus everything it `implies:`
...
const SKILL = 'ki-website-cloudflare'
