...
- **Agent Client Protocol (ACP):** the [version 1 protocol overview](https://agentclientprotocol.com/protocol/v1/overview) and [schema](https://agentclientprotocol.com/protocol/v1/schema) define the stable wire contract; the [governance page](https://agentclientprotocol.com/community/governance) records interim joint stewardship by Zed and JetBrains.
- **Agent Host Protocol (AHP):** the [specification overview](https://microsoft.github.io/agent-host-protocol/specification/overview.html), [0.7.0 release](https://github.com/microsoft/agent-host-protocol/releases/tag/spec%2Fv0.7.0), and [versioning policy](https://microsoft.github.io/agent-host-protocol/specification/versioning) establish a versioned pre-1.0 Microsoft protocol with channel-specific stability.
...
- **AHP:** the official [implementation catalogue](https://microsoft.github.io/agent-host-protocol/guide/implementations.html) currently lists implementations in or directly associated with the Microsoft project. It is catalogue evidence, not independent interoperability evidence.
