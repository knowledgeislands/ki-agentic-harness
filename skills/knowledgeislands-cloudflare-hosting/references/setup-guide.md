...
Add the `[knowledgeislands-cloudflare-hosting]` table so the mechanical checker can find the repo:
...
```bash
bun /path/to/skills/knowledgeislands-cloudflare-hosting/scripts/audit-cloudflare-hosting.ts <repo-root>
```
