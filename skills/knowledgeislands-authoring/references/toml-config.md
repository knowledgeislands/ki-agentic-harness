...
- **One table per skill, named for the skill** (`[knowledgeislands-repo]`), with sub-tables nested under it (`[knowledgeislands-repo.checks]`) — the file reads as a map of skill → its settings. The ownership rules behind this live in the contract (above).
