...
add(
  ...
  "MD-link [J]: link text must be descriptive (words you'd skim for) beyond what MD059 enforces. " +
    ...
    'in KB note content and agent system prompts (scoped by knowledgeislands-kb / knowledgeislands-agents LINK-2). ' +
...
if (!hasKiConfig) {
  add('SKIP', 'toml', 'no .ki-config.toml in repo — TOML criteria not applicable')
} else {
  add(
    'ADVISORY',
    'toml-keys',
