...
- **In-house scan:** `bun run ki:skills:lint` — all **thirteen** `ki-*` skills PASS for FAIL, 0 fail. One WARN (REF-3) on `ki-mcp`'s own `sources.md` — out of scope for this skill's refresh.
