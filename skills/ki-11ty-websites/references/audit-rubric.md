...
- [ ] [J] POLISH — `assets.directory` in `site/wrangler.jsonc` is `"./dist"` (pointing at `site/dist/`) — verified by `ki-cloudflare-hosting`, named here as the seam. (§9)
