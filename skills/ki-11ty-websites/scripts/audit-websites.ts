 ...
 *   bun scripts/audit-websites.ts --init             # print the default [ki-11ty-websites] block
 *
 * Checks the SITE-BUILD DELTA of the standard the `ki-11ty-websites` skill
 ...
 * check serving the dist/ — that is `ki-cloudflare-hosting`; run
