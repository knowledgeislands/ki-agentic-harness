...
against). Run it on the monthly `knowledgeislands-skills-refresh` routine's cadence (which covers every governance skill), or when someone
asks "is the Streams model still current".
