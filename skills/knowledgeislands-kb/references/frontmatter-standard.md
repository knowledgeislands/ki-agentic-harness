...
External reference material. The kinds below are the cross-base **core**; a base may declare finer entity kinds (`resources/book`, `resources/location`, …) under its own config. Governed by `knowledgeislands-kb`.
