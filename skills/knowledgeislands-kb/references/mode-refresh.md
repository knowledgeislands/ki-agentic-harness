...
1. **Read [the source list](sources.md)** - the canonical structure definition (arcadia-agentic-harness `docs/knowledge-islands.md`) and the bases actively using this skill, each with a `last reviewed` date.
