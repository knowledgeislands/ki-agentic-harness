...
2. Run `bun skills/ki-housekeeping/scripts/audit.ts [repo-path]`. It emits findings on the severity ladder (FAIL / WARN / POLISH / ADVISORY / INFO / NA / PASS per `ki-engineering`'s [checker-contract.md](../../ki-engineering/references/checker-contract.md)); non-zero exit iff any FAIL.
