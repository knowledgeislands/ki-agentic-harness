...
1. **Read [`sources.md`](sources.md)** — the reference implementation (arcadia-principal Activities/) and the sibling skills this one composes with, each with a `last reviewed` date.
