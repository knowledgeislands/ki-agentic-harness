...
| ------------------------------------------------ | ------------------------------------------------------- | ------------- |
| arcadia-principal `Admin/Operations/Activities/` | Reference implementation of the activity pattern        | 2026-06-26    |
| `knowledgeislands-kb` SKILL.md                   | Zone model and Admin/ subdivision that hosts activities | 2026-06-26    |
| `knowledgeislands-harness` SKILL.md              | Four-part bundle layout; skills/ resolution path        | 2026-06-26    |
