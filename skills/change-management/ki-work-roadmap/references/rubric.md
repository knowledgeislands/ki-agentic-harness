...
- **ITEM-2 [M] — item state and theme grouping** — Each item has valid theme, horizon, adoption boundary, status, baseline, dependency, and optional timestamp-pair fields. (standards-repository-roadmaps.md)
