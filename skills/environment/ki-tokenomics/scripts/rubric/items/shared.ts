...
export const mechanical = (code: string, title: string, description: string, level: 'FAIL' | 'WARN' = 'WARN'): RubricItem<TokenomicsRubricContext> => ({
...
export const judgment = (code: string, title: string, description: string): RubricItem<TokenomicsRubricContext> => ({ code, title, description, sources: ['standards.md'], judgment: { prompt: description } })
