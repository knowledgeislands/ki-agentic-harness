...
2. Run `bun skills/environment/ki-housekeeping/scripts/audit.ts [repo-path]`. It emits findings on the severity ladder (FAIL / WARN / POLISH / ADVISORY / INFO / NA / PASS per `ki-skills`' [checker contract](../../../general-governance/ki-skills/references/checker-contract.md)); non-zero exit iff any FAIL.
