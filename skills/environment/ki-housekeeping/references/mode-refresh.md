...
3. **Diff and update** [memory-format.md](memory-format.md), [rubric.md](rubric.md), and `SKILL.md` where the live behavior has moved; update [`scripts/govern.ts`](../scripts/govern.ts) to match.
