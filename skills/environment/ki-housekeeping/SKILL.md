...
- Composes on `ki-authoring` for the Markdown formatting delta of the memory files; the mechanical-checker contract and severity ladder are `ki-engineering`'s [checker-contract.md](../../general-governance/ki-skills/references/checker-contract.md).
