...
The checker is [`scripts/audit.ts`](scripts/audit.ts); the quotable invariant is [the standard](references/standards.md); the checkable criteria are [the rubric](references/rubric.md).
