...
REFRESH last run **2026-06-21**. Cadence: monthly, alongside the other governance skills (the `knowledgeislands-skills-refresh` routine). No drift this cycle: every pin is unchanged since the 2026-06-18 review.
