...
name: ki-kb-curator
description: >
  Knowledge Islands KB Curator — owns KB zone health, note structure, and conformance to the knowledgeislands-kb standard … Does not own SKILL.md authoring — that is ki-skills-lead — or decision record authoring — that is ki-decision-author.
model: inherit
color: green
---
```
