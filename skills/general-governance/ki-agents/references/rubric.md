...
→ [standard §5](standards.md#5-frontmatter-optional-fields) · [§8](standards.md#8-tools--model)
...
→ [standard §6](standards.md#6-system-prompt-size--focus) · [§7](standards.md#7-system-prompt-structure--quality)
...
→ [standard §9](standards.md#9-lane--delegation)
...
→ [standard §10](standards.md#10-linking)
...
→ [standard §12](standards.md#12-longevity)
...
→ [standard §13](standards.md#13-cross-agent-collision) · run the linter over the **whole set**, not one agent
