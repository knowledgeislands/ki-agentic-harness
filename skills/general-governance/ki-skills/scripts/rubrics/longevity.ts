...
export const LONG_3: RubricItem<RefreshContext> = {
  code: 'LONG-3',
...
export const LONG_4: RubricItem<RefreshContext> = {
  code: 'LONG-4',
...
export const LONGEVITY: readonly RubricItem<RefreshContext>[] = [LONG_1, LONG_2, LONG_3, LONG_4]
