...
→ [standard §11](standards.md#11-knowledge-islands-linking--portability)
...
→ [standard §12](standards.md#12-knowledge-islands-skill-shape)
...
→ [standard §13](standards.md#13-process--evaluation) · not checkable from files alone
...
→ [standard §14](standards.md#14-cross-skill-collision) · run the linter over the **whole set**, not one skill
