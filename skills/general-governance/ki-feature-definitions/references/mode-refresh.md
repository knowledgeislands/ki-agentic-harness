...
1. **Read [the source list](sources.md)** and re-examine the reference corpus. Confirm the standard, rubric, and [`../scripts/govern.ts`](../scripts/govern.ts) still match how a mature Feature Definitions corpus is actually written.
