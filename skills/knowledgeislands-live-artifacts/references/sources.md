...
| ---------------------------------------------------- | ----------------------------------------------------- | ------------- |
| arcadia-principal `Admin/Operations/Live Artifacts/` | Reference implementation of the live artifact pattern | 2026-06-27    |
| `knowledgeislands-kb` SKILL.md                       | Admin/Operations/ zone that hosts live artifacts      | 2026-06-27    |
| `knowledgeislands-authoring` SKILL.md                | Markdown style for the .md source files               | 2026-06-27    |
