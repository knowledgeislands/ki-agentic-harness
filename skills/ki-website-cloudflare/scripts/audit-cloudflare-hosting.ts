 ...
 *   bun scripts/audit-cloudflare-hosting.ts --init        # print the default [ki-website-cloudflare] block
 *
 ...
 * (that is `ki-website`; run audit-websites.ts first) nor check the common
