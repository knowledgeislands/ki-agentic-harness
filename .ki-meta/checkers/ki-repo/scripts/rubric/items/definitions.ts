...
export const FILES_1 = ITEMS[0]; export const FILES_2 = ITEMS[1]; export const FILES_3 = ITEMS[2]; export const FILES_J1 = ITEMS[3]
export const GH_1 = ITEMS[4]; export const GH_2 = ITEMS[5]; export const GH_3 = ITEMS[6]
export const PKG_1 = ITEMS[7]; export const MERGE_1 = ITEMS[8]; export const TOGGLE_1 = ITEMS[9]; export const VIS_1 = ITEMS[10]
export const TOPICS_1 = ITEMS[11]; export const BP_1 = ITEMS[12]; export const DEP_1 = ITEMS[13]; export const SEC_1 = ITEMS[14]
export const ACT_1 = ITEMS[15]; export const CHECKS_1 = ITEMS[16]; export const COV_1 = ITEMS[17]; export const STRUCT_1 = ITEMS[18]
export const STRUCT_2 = ITEMS[19]; export const VENDOR_1 = ITEMS[20]; export const CAPABILITY_COMPLETE = ITEMS[21]; export const ACCESS_1 = ITEMS[22]
export const RUNTIMES_1 = ITEMS[23]; export const RUNTIMES_J1 = ITEMS[24]; export const LINK_1 = ITEMS[25]; export const DESCFIT_1 = ITEMS[26]
export const OVR_J1 = ITEMS[27]; export const SYNC_1 = ITEMS[28]
