...
export const CFG_1 = mechanical('CFG-1', 'Config validates down', 'The ki-tokenomics configuration table is parsed and validated down.', 'FAIL')
...
export const CFG_5 = mechanical('CFG-5', 'Model bindings are valid', 'Optional model-tier bindings have valid keys and non-empty values.', 'FAIL')
