...
2. **Re-fetch each** (WebFetch; fall back to WebSearch if blocked) and diff against the format standard ([`dr-format.md`](dr-format.md)) and the rubric ([`rubric.md`](rubric.md)).
