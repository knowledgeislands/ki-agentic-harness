...
- **FILES-2 [M] — Derived metadata is ignored** — Derived .ki-meta audit and conform artifacts are ignored rather than committed. (standards.md)
...
- **VENDOR-1 [M] — Vendored payload integrity** — Manifest-listed .ki-meta payloads exist and match their recorded hashes. (standards.md)
