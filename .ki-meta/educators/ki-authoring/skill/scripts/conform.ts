#!/usr/bin/env bun
/** Safe-write CONFORM entry point for the structured ki-authoring rubric. */
...
Apply safe Markdown authoring configuration and normalisation.
  ...
  subjects: [
    {
      ...
      context: createAuthoringContextFactory({ target, dryRun: parsedReporter.arguments.includes('--dry-run') })
    }
  ]
})
