...
if (remaining.length > 1) {
  process.stderr.write('error: audit accepts at most one repository path\n')
  process.exit(2)
}
  ...
  subjects: [
    {
      ...
      context: () => createHousekeepingContext({ repoRoot, memoryDir: targetMemory, dryRun: true })
    }
  ],
