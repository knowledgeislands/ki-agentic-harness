...
const generatedKnip = `{
  "ignore": [".ki/**", "src/generated/**", ".claude/skills/**", ".claude/agents/**", ".agents/skills/**"]
}\n`
const generatedMarkdownlint = `{
  "ignores": [".ki/**", "src/generated/**", ".claude/**", ".agents/**"]
}\n`
const generatedDirs = ['.ki', 'src/generated', '.claude/skills', '.claude/agents', '.agents/skills']
...

{
  const dir = fixture({})
  try {
    const checkerDir = join(dir, '.ki', 'bootstrap', 'checkers', 'ki-fixture', 'scripts')
    ...
    pkg.scripts['ki:fixture:audit'] = 'bun .ki/bootstrap/checkers/ki-fixture/scripts/audit.ts .'
    pkg.scripts['ki:fixture:conform'] = 'bun .ki/bootstrap/checkers/ki-fixture/scripts/conform.ts .'
    writeFileSync(packagePath, `${JSON.stringify(pkg, null, 2)}\n`)
    check('direct per-skill checker commands fail SCR-4', hasFinding(run(dir), 'SCR-4', 'FAIL', 'must use'))

    pkg.scripts['ki:fixture:audit'] = 'bun .ki/bin/aggregate.ts audit --skill ki-fixture'
    pkg.scripts['ki:fixture:conform'] = 'bun .ki/bin/aggregate.ts conform --skill ki-fixture'
    writeFileSync(packagePath, `${JSON.stringify(pkg, null, 2)}\n`)
