#!/usr/bin/env bun
/** Read-only AUDIT entry point for the structured Decision Records rubric. */
...
Audit a Decision Records collection.
...
const result = runChecker({
  ...
  subjects: [{ familyCodes: DECISION_RECORDS_FAMILY_CODES, context: createDecisionRecordsContextFactory({ target }) }],
