...
- **Skills** ([`skills/`](skills)) — 61 reusable [Agent Skills](https://agentskills.io/specification): 51 governance skills that hold standards and 10 process skills that drive workflows. Use [choose a skill by outcome](https://knowledgeislands.info/guidance/skills/by-outcome/) to find the right capability or journey; the generated [capability catalogue](skills/README.md#generated-capability-catalogue) is the exact local inventory and publishes declared dependency facts.
