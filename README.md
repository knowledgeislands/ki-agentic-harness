...
- **Skills** ([`skills/`](skills)) — 60 reusable [Agent Skills](https://agentskills.io/specification): 50 governance skills that hold standards and 10 process skills that drive workflows. Use [choose a skill by outcome](docs/guides/skills-by-outcome.md) to find the right capability or journey; the generated [capability catalogue](skills/README.md#generated-capability-catalogue) is the exact local inventory and publishes declared dependency facts.
