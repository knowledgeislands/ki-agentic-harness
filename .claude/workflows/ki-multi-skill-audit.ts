...
const CONCERNS = [
  ...
  { name: "11ty-websites", checker: "bun skills/knowledgeislands-11ty-websites/scripts/audit-11ty-websites.ts" },
  { name: "cloudflare-hosting", checker: "bun skills/knowledgeislands-cloudflare-hosting/scripts/audit-cloudflare-hosting.ts" },
  { name: "agents", checker: "bun skills/knowledgeislands-agents/scripts/audit-agents.ts" },
